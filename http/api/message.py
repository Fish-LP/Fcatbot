...
class MessageAPi:
    ...
    async def mark_msg_as_read(self, group_id: Union[int, str] = None, user_id: Union[int, str] = None):
        ...
        """
        if group_id:
            return await self.http_client.post("/mark_msg_as_read", {"group_id": group_id})
        elif user_id:
            return await self.http_client.post("/mark_msg_as_read", {"user_id": user_id})
    ...
    async def mark_group_msg_as_read(self, group_id: Union[int, str]):
        ...
        :return: 设置群聊已读
        """
        return await self.http_client.post("/mark_group_msg_as_read", {"group_id": group_id})
    ...
    async def mark_private_msg_as_read(self, user_id: Union[int, str]):
        ...
        :return: 设置私聊已读
        """
        return await self.http_client.post("/mark_private_msg_as_read", {"user_id": user_id})

    async def mark_all_as_read(self):
        """
        :return: 设置所有消息已读
        """
        return await self.http_client.post("/_mark_all_as_read", {})
    ...
    async def delete_msg(self, message_id: Union[int, str]):
        ...
        :return: 删除消息
        """
        return await self.http_client.post("/delete_msg", {"message_id": message_id})
    ...
    async def get_msg(self, message_id: Union[int, str]):
        ...
        :return: 获取消息
        """
        return await self.http_client.post("/get_msg", {"message_id": message_id})
    ...
    async def get_image(self, image_id: str):
        ...
        :return: 获取图片消息详情
        """
        return await self.http_client.post("/get_image", {"file_id": image_id})
    ...
    async def get_file(self, file_id: str):
        ...
        :return: 获取文件消息详情
        """
        return await self.http_client.post("/get_file", {"file_id": file_id})
    ...
    async def get_recent_contact(self, count: int):
        ...
        :return: 最近消息列表
        """
        return await self.http_client.post("/get_recent_contact", {"count": count})
    ...
    async def fetch_emoji_like(
        ...
        if count:
            params["count"] = count
        return await self.http_client.post("/fetch_emoji_like", params)
    ...
    async def get_forward_msg(self, message_id: str):
        ...
        :return: 获取合并转发消息
        """
        return await self.http_client.post("/get_forward_msg", {"message_id": message_id})
    ...
    async def send_poke(self, user_id: Union[int, str], group_id: Union[int, str] = None):
        ...
        if group_id:
            params["group_id"] = group_id
        return await self.http_client.post("/send_poke", params)
