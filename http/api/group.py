...
class GroupApi:
    ...
    async def get_group_system_msg(self, group_id: Union[int, str]):
        ...
        \:return: 获取群系统消息
        """
        return await self.http_client.post("/get_group_system_msg", {"group_id": group_id})
    ...
    async def get_essence_msg_list(self, group_id: Union[int, str]):
        ...
        \:return: 获取精华消息列表
        """
        return await self.http_client.post("/get_essence_msg_list", {"group_id": group_id})
    ...
    async def set_essence_msg(self, message_id: Union[int, str]):
        ...
        \:return: 设置精华消息
        """
        return await self.http_client.post("/set_essence_msg", {"message_id": message_id})
    ...
    async def delete_essence_msg(self, message_id: Union[int, str]):
        ...
        \:return: 删除精华消息
        """
        return await self.http_client.post("/delete_essence_msg", {"message_id": message_id})
    ...
    async def set_group_leave(self, group_id: Union[int, str]):
        ...
        \:return: 退出群组
        """
        return await self.http_client.post("/set_group_leave", {"group_id": group_id})
    ...
    async def get_group_notice(self, group_id: Union[int, str]):
        ...
        \:return: 获取群公告
        """
        return await self.http_client.post("/_get_group_notice", {"group_id": group_id})
    ...
    async def get_group_info(self, group_id: Union[int, str]):
        ...
        \:return: 获取群信息
        """
        return await self.http_client.post("/get_group_info", {"group_id": group_id})
    ...
    async def get_group_info_ex(self, group_id: Union[int, str]):
        ...
        \:return: 获取群信息(拓展)
        """
        return await self.http_client.post("/get_group_info_ex", {"group_id": group_id})
    ...
    async def get_group_root_files(self, group_id: Union[int, str]):
        ...
        \:return: 获取群根目录文件列表
        """
        return await self.http_client.post("/get_group_root_files", {"group_id": group_id})
    ...
    async def get_group_list(self, no_cache: bool = False):
        ...
        \:return: 获取群列表
        """
        return await self.http_client.post("/get_group_list", {"no_cache": no_cache})
    ...
    async def get_group_honor_info(self, group_id: Union[int, str]):
        ...
        \:return: 获取群荣誉信息
        """
        return await self.http_client.post("/get_group_honor_info", {"group_id": group_id})
    ...
    async def get_group_at_all_remain(self, group_id: Union[int, str]):
        ...
        """
        return await self.http_client.post("/get_group_at_all_remain", {"group_id": group_id})
    ...
    async def set_group_sign(self, group_id: Union[int, str]):
        ...
        \:return: 群打卡
        """
        return await self.http_client.post("/set_group_sign", {"group_id": group_id})
    ...
    async def send_group_sign(self, group_id: Union[int, str]):
        ...
        \:return: 群打卡
        """
        return await self.http_client.post("/send_group_sign", {"group_id": group_id})
    ...
    async def send_group_forward_msg(
        ...
        return await self.http_client.post("/send_private_forward_msg", payload)