...
# @LastEditTime : 2025-10-02 19:32:15
...
class SystemApi:
    ...
    async def get_robot_uin_range(self):
        ...
        :return: 获取机器人 QQ 号范围
        """
        return await self.ws_client.api("get_robot_uin_range", {})
    ...
    async def ocr_image(self, image: str):
        ...
        :return: OCR 图片识别
        """
        return await self.ws_client.api("ocr_image", {"image": image})
    ...
    async def translate_en2zh(self, words: List[str]):
        ...
        :return: 英文翻译为中文
        """
        return await self.ws_client.api("translate_en2zh", {"words": words})

    async def get_login_info(self):
        """
        :return: 获取登录号信息
        """
        return await self.ws_client.api("get_login_info", {})
    ...
    async def download_file(
        ...
        if base64:
            ...
            if name:
                params["name"] = name
        return await self.ws_client.api("download_file", params)
    ...
    async def get_cookies(self, domain: str):
        ...
        :return: 获取 cookies
        """
        return await self.ws_client.api("get_cookies", {"domain": domain})
    ...
    async def get_csrf_token(self):
        ...
        """
        return await self.ws_client.api("get_csrf_token", {})
    ...
    async def get_credentials(self, domain: str):
        ...
        :return: 获取 QQ 相关接口凭证
        """
        return await self.ws_client.api("get_credentials", {"domain": domain})
    ...
    async def get_model_show(self, model: str):
        ...
        :return: 获取模型显示
        """
        return await self.ws_client.api("_get_model_show", {"model": model})

    async def can_send_image(self):
        """
        :return: 检查是否可以发送图片
        """
        return await self.ws_client.api("can_send_image", {})

    async def nc_get_packet_status(self):
        """
        :return: 获取 packet 状态
        """
        return await self.ws_client.api("nc_get_packet_status", {})

    async def can_send_record(self):
        """
        :return: 检查是否可以发送语音
        """
        return await self.ws_client.api("can_send_record", {})

    async def get_status(self):
        """
        :return: 获取状态
        """
        return await self.ws_client.api("get_status", {})

    async def nc_get_rkey(self):
        """
        :return: 获取 rkey
        """
        return await self.ws_client.api("nc_get_rkey", {})

    async def get_version_info(self):
        """
        :return: 获取版本信息
        """
        return await self.ws_client.api("get_version_info", {})
    ...
    async def get_group_shut_list(self, group_id: Union[int, str]):
        ...
        :return: 获取群禁言列表
        """
        return await self.ws_client.api("get_group_shut_list", {"group_id": group_id})
