...
# @LastEditTime : 2025-03-16 02:13:34
...
OFFICIAL_PRIVATE_COMMAND_EVENT = config.get("OFFICIAL_PRIVATE_COMMAND_EVENT", 'meta.bot.group.command')
OFFICIAL_GROUP_COMMAND_EVENT = config.get("OFFICIAL_GROUP_COMMAND_EVENT", 'meta.bot.private.command')
OFFICIAL_GROUP_MESSAGE_EVENT = config.get("OFFICIAL_GROUP_MESSAGE_EVENT", 'meta.bot.group.message')
OFFICIAL_PRIVATE_MESSAGE_EVENT = config.get("OFFICIAL_PRIVATE_MESSAGE_EVENT", 'meta.bot.private.message')
